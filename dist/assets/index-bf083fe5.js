    ...
    for (let i = 0; i < len; ) {
      ...
      if (rtl) {
        for (let j2 = i; j2 > start; ) {
          let end = j2, l = types[--j2] != 2;
          while (j2 > start && l == (types[j2 - 1] != 2))
            j2--;
          order.push(new BidiSpan(j2, end, l ? 2 : 1));
        }
      } else {
    ...
    if (change.from >= sel.from && change.to <= sel.to && change.to - change.from >= (sel.to - sel.from) / 3 && (!newSel || newSel.main.empty && newSel.main.from == change.from + change.insert.length) && view.inputState.composing < 0) {
      ...
      if (startState.selection.ranges.length > 1 && view.inputState.composing >= 0 && change.to <= sel.to && change.to >= sel.to - 10) {
        ...
        tr = startState.changeByRange((range) => {
          ...
          if (range.to - range.from != size2 || view.state.sliceDoc(from, to) != replaced || // Unfortunately, there's no way to make multiple
...
const tooltipPlugin = /* @__PURE__ */ ViewPlugin.fromClass(class {
  ...
  writeMeasure(measured) {
    ...
    for (let i = 0; i < this.manager.tooltips.length; i++) {
      ...
      let width = size2.right - size2.left, height = (_a2 = knownHeight.get(tView)) !== null && _a2 !== void 0 ? _a2 : size2.bottom - size2.top;
...
function buildTree(data) {
  ...
  function takeNode(parentStart, minPos, children2, positions2, inRepeat) {
    let { id, start, end, size: size2 } = cursor2;
...
const findNext = /* @__PURE__ */ searchCommand((view, { query }) => {
  ...
  view.dispatch({
    selection: selection2,
    effects: [announceMatch(view, next), config2.scrollToMatch(selection2.main)],
...
const findPrevious = /* @__PURE__ */ searchCommand((view, { query }) => {
  ...
  view.dispatch({
    selection: selection2,
    effects: [announceMatch(view, prev), config2.scrollToMatch(selection2.main)],
    userEvent: "select.search"
  });
  return true;
});
...
const replaceNext = /* @__PURE__ */ searchCommand((view, { query }) => {
  ...
  if (next) {
    ...
    effects.push(state.facet(searchConfigFacet).scrollToMatch(selection2.main));
  }
  view.dispatch({
    changes,
    selection: selection2,
...
function probablyInString(state, pos, quoteToken, prefixes2) {
  ...
  let maxPrefix = prefixes2.reduce((m, p2) => Math.max(m, p2.length), 0);
  for (let i = 0; i < 5; i++) {
...
* Surmon
*/
var h = Object.freeze({ autofocus: false, disabled: false, indentWithTab: true, tabSize: 2, placeholder: "", autoDestroy: true, extensions: [basicSetup] }), y = Symbol("vue-codemirror-global-config");
var O, j = function(e) {
  var t2 = e.onUpdate, n = e.onChange, o = e.onFocus, r = e.onBlur, u = function(e2, t3) {
    var n2 = {};
    for (var o2 in e2)
      Object.prototype.hasOwnProperty.call(e2, o2) && t3.indexOf(o2) < 0 && (n2[o2] = e2[o2]);
    if (null != e2 && "function" == typeof Object.getOwnPropertySymbols) {
      var r2 = 0;
      for (o2 = Object.getOwnPropertySymbols(e2); r2 < o2.length; r2++)
        t3.indexOf(o2[r2]) < 0 && Object.prototype.propertyIsEnumerable.call(e2, o2[r2]) && (n2[o2[r2]] = e2[o2[r2]]);
    }
    return n2;
  ...
  return EditorState.create({ doc: u.doc, selection: u.selection, extensions: (Array.isArray(u.extensions) ? u.extensions : [u.extensions]).concat([EditorView.updateListener.of(function(e2) {
    t2(e2), e2.docChanged && n(e2.state.doc.toString(), e2), e2.focusChanged && (e2.view.hasFocus ? o(e2) : r(e2));
  })]) });
}, S = function(e) {
  var t2 = new Compartment();
  return { compartment: t2, run: function(n) {
    t2.get(e.state) ? e.dispatch({ effects: t2.reconfigure(n) }) : e.dispatch({ effects: StateEffect.appendConfig.of(t2.of(n)) });
  } };
}, x = function(e, t2) {
  var n = S(e), o = n.compartment, r = n.run;
  return function(n2) {
    var u = o.get(e.state);
    r((null != n2 ? n2 : u !== t2) ? t2 : []);
  };
}, C = { type: Boolean, default: void 0 }, D = { autofocus: C, disabled: C, indentWithTab: C, tabSize: Number, placeholder: String, style: Object, autoDestroy: C, phrases: Object, root: Object, extensions: Array, selection: Object }, U = { modelValue: { type: String, default: "" } }, w = Object.assign(Object.assign({}, D), U);
!function(e) {
  e.Change = "change", e.Update = "update", e.Focus = "focus", e.Blur = "blur", e.Ready = "ready", e.ModelUpdate = "update:modelValue";
}(O || (O = {}));
var z = {};
z[O.Change] = function(e, t2) {
  return true;
...
var F = Object.assign(Object.assign({}, z), B), P = defineComponent({ name: "VueCodemirror", props: Object.assign({}, w), emits: Object.assign({}, F), setup: function(t2, s) {
  var f = shallowRef(), d = shallowRef(), C2 = shallowRef(), D2 = Object.assign(Object.assign({}, h), inject(y, {})), U2 = computed(function() {
    var e = {};
    return Object.keys(toRaw(t2)).forEach(function(n) {
      var o;
      "modelValue" !== n && (e[n] = null !== (o = t2[n]) && void 0 !== o ? o : D2[n]);
    }), e;
  });
  return onMounted(function() {
    var e;
    d.value = j({ doc: t2.modelValue, selection: U2.value.selection, extensions: null !== (e = D2.extensions) && void 0 !== e ? e : [], onFocus: function(e2) {
      ...
      e2 !== t2.modelValue && (s.emit(O.Change, e2, n2), s.emit(O.ModelUpdate, e2, n2));
    ...
    var n = function(e2) {
      ...
      return { focus: function() {
        return e2.focus();
      }, getDoc: t3, setDoc: function(n3) {
        n3 !== t3() && e2.dispatch({ changes: { from: 0, to: e2.state.doc.length, insert: n3 } });
    ...
    return h$1("div", { class: "v-codemirror", style: { display: "contents" }, ref: f });
  };
} }), T = P;
...
class Manager {
  ...
  _do(name2, ...args) {
    const functionName = "_" + address_map.get(name2);
  ...
  setup(__props) {
    ...
    function _parse(str) {
      ...
      for (let index = 0; index < str.length; index++) {
        ...
        if (!str[index + 1])
          break;
        if (!(currentChar.charCodeAt() >= 0 && currentChar.charCodeAt() <= 31 && currentChar.charCodeAt() != 10)) {
          if (currentChar.charCodeAt() == 10)
            currentChar = " ";
      ...
      if (str.length > 0) {
        result = result.join("").toLowerCase().split(" ").map((tk) => instruction_map.get(tk) ? instruction_map.get(tk) : tk);
      }
      return result;
    }
